...
import { GetGivenStockToGroup } from "@/src/services/apiService/request/requestServices";
...
export default function GivenToGroupIndex() {
  ...
  const {
    ...
    queryKey: ["givenStockToGroup"],
    queryFn: GetGivenStockToGroup,
    ...
    },
    {
      ...
      cell: (info) => {
        ...
        return (
          <div>
            <button
              onClick={() => router.push(`/inventory/givenToGroup/items/${id}`)}
  ...
  const table = (
    <>
      <AddButton
        ...
        buttonTitle="Give Stock"
        link="/inventory/givenToGroup/create"
      />
