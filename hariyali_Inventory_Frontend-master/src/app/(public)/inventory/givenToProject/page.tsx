...
import { GetGivenItemsToProject } from "@/src/services/apiService/request/requestServices";
...
export default function GivenToProjectIndex() {
  ...
  const {
    ...
    queryKey: ["givenToProject"],
    queryFn: GetGivenItemsToProject,
  });
      ...
      cell: (info) => {
        ...
        return (
          <div>
            <button
              onClick={() =>
                router.push(`/inventory/givenToProject/items/${id}`)
              }
  ...
  const table = (
    <>
      <AddButton
        ...
        link="/inventory/givenToProject/create"
