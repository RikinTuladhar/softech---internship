...
import { GetItemsGivenByCompany } from "@/src/services/apiService/request/requestServices";
...
export default function TakenItemsFromCompanyList() {
  ...
  const {
    ...
    queryKey: ["itemsGivenByCompany", id],
    queryFn: () => GetItemsGivenByCompany(parseInt(id)),
    enabled: !!id,
  });
  ...
  const table = (
    <div className="mx-10">
      <div>
        <h1 className="text-2xl font-bold mx-4 my-10">Given Item List</h1>
      </div>
      <div className="">
        <div>
